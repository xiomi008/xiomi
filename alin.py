...
cl = LINETCR.LINE()
cl.login(token="EnhtOHaC8xOQvblut0A2.YC9IBRGvPW1zYoCFN9PiCG.eORGSmjisUOqxbvoy9VF/Gd+RdR12y8tCI5k4xwDb3Y=")
cl.loginResult()

#cl = LINETCR.LINE()
#cl.login(token="En86lWE0By4ITdlH5Ca2.YC9IBRGvPW1zYoCFN9PiCG.H20SFm6XFSgE3UBlrwlqf04yYWfXqesz7aD9wBFn/0g=")
#cl.loginResult()
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                cl.sendText(msg.to, "[ʂıɱı] " + data['result']['response'].encode('utf-8'))
...
#==============================================================================#
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Թɾσϯεɕϯίση ςεϯ ϯσ ση")
                    else:
                        cl.sendText(msg.to,"Թɾσϯεɕϯίση αʆɾεαδψ ση")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Թɾσϯεɕϯίση ςεϯ ϯσ ση")
                ...
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σи")
                    else:
                        cl.sendText(msg.to,"ρяσтє¢тισи qя αℓяєα∂у σи")
                else:
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ρяσтє¢тισи qя ѕєт тσ σff")
                    else:
                        cl.sendText(msg.to,"Protection qя αℓяєα∂у σff")
                else:
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ρяσтє¢тισи ιиνιтє ѕєт тσ σff")
                    else:
                        cl.sendText(msg.to,"ρяσтє¢тισи ιиνιтє αℓяєα∂у σff")
                else:
                ...
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ιиνιтє ѕєт тσ σff")
                    else:
                        cl.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ιиνιтє αℓяєα∂у σff")
                else:
...
#==============================================================================#
                ...
                cl.sendText(msg.to,"ʂųƈƈɛʂʂ ąƈɬı۷ąɬɛɖ ʂıɱıʂıɱı")
                
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                cl.sendText(msg.to,"ʂųƈƈɛʂʂ ɖɛąƈɬı۷ɛ ʂıɱıʂıɱı")
